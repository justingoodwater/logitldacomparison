...
# both the logit model and LDA models predict with the same accuracy
# the logit model predicts 'up' slightly worse and 'down' slightly better than the LDA model